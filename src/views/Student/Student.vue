...
const columns = [
  ...
  { title: "联系电话", dataIndex: "stu_phone" },
  { title: "联系电话2", dataIndex: "stu_phone2" },
  { title: "出生日期", dataIndex: "stu_born" },
  { title: "学历", dataIndex: "stu_qualification", slots: { customRender: 'qualification' }  },
  { title: "毕业院校", dataIndex: "stu_school" },
  { title: "院校专业", dataIndex: "stu_major" },
